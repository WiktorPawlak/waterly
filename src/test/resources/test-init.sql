...
INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2023-09-16', true, 3);