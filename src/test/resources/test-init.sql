...
INSERT INTO public.water_meter (id, version, active, expiry_date, starting_value, expected_daily_usage, type, apartment_id, created_on, updated_on) VALUES (nextval('water_meter_id_seq'), 0, true, now() + INTERVAL '360 days', 0.000, 0.000, 'MAIN', null, now(), now());
