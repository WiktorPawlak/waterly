...
VALUES (nextval('account_id_seq'), 0, true, 'admin', '$2a$04$m9vbbL2RTbV/XNC44TEZ0e.t9WH2Q6hjtyEem/siFCdNS564hW68q', 'en_US', 'CONFIRMED', 1, now(), now(), false, '610cc564-f5bf-11ed-b67e-0242ac120002');
...
INSERT INTO public.account (id, version, active, login, password, locale, account_state, account_details_id, created_on, updated_on, two_factor_enabled, otp_secret)
VALUES (nextval('account_id_seq'), 0, true, 'new', '$2a$04$j/yqCtlHxKmdxHMWxaji4OD1w591LIMNDGBqUbCpD6HTM4aj2uLiS', 'en_US', 'CONFIRMED', 2, now(), now(), false, '7a1dbcfc-f5bf-11ed-b67e-0242ac120002');
INSERT INTO public.role (permission_level, id, active, version, account_id, created_on, updated_on)
...
INSERT INTO public.account (id, version, active, login, password, locale, account_state, account_details_id, created_on, updated_on, two_factor_enabled, otp_secret)
VALUES (nextval('account_id_seq'), 0, true, 'tomdut', '$2a$04$j/yqCtlHxKmdxHMWxaji4OD1w591LIMNDGBqUbCpD6HTM4aj2uLiS', 'en_US', 'CONFIRMED', 3, now(), now(), false, '81250e56-f5bf-11ed-b67e-0242ac120002');
INSERT INTO public.role (permission_level, id, active, version, account_id, created_on, updated_on)
...
INSERT INTO public.account_details (id, version, email, first_name, last_name, phone_number, created_on, updated_on) VALUES (nextval('account_details_id_seq'), 0, 'skulmikpl@gmail.com', 'Piotr', 'Skonieczny', '725510347', now(), now());
INSERT INTO public.account (id, version, active, login, password, locale, account_state, account_details_id, created_on, updated_on, two_factor_enabled, otp_secret) VALUES (nextval('account_id_seq'), 0, true, 'skulmik', '$2a$04$j/yqCtlHxKmdxHMWxaji4OD1w591LIMNDGBqUbCpD6HTM4aj2uLiS', 'en_US', 'TO_CONFIRM', 4, now(), now(), false, '83d7c4cc-f5bf-11ed-b67e-0242ac120002');
...
INSERT INTO public.apartment (id, version, number, created_on, updated_on, area, owner_id) VALUES (nextval('apartment_id_seq'), 0, '12b', now(), now(), 40.00, 2);
INSERT INTO public.water_meter (id, version, active, serial_number, expiry_date, starting_value, expected_daily_usage, type, apartment_id, created_on, updated_on) VALUES (nextval('water_meter_id_seq'), 0, true, '1234567 A', now() + INTERVAL '360 days', 100.000, 500.000, 'HOT_WATER', 1, now(), now());
INSERT INTO public.water_meter (id, version, active, serial_number, expiry_date, starting_value, expected_daily_usage, type, apartment_id, created_on, updated_on) VALUES (nextval('water_meter_id_seq'), 0, true, '1234567 B', now() + INTERVAL '360 days', 100.000, 50.000, 'COLD_WATER', 1, now(), now());
INSERT INTO public.water_meter (id, version, active, serial_number, expiry_date, starting_value, expected_daily_usage, type, apartment_id, created_on, updated_on) VALUES (nextval('water_meter_id_seq'), 0, true, '1234567 C', now() + INTERVAL '360 days', 0.000, 0.000, 'MAIN', null, now(), now());
...
INSERT INTO public.water_usage_stats (id, created_on, updated_on, version, cold_water_usage, hot_water_usage, year_month, apartment_id) VALUES (nextval('water_usage_stats_id_seq'), now(), now(), 0, 40.000, 60.000, '2023-09-01', 1);
INSERT INTO public.water_usage_stats (id, created_on, updated_on, version, cold_water_usage, hot_water_usage, year_month, apartment_id) VALUES (nextval('water_usage_stats_id_seq'), now(), now(), 0, 40.000, 60.000, '2023-10-01', 1);
INSERT INTO public.water_usage_stats (id, created_on, updated_on, version, cold_water_usage, hot_water_usage, year_month, apartment_id) VALUES (nextval('water_usage_stats_id_seq'), now(), now(), 0, 40.000, 60.000, '2023-09-01', 2);
INSERT INTO public.water_usage_stats (id, created_on, updated_on, version, cold_water_usage, hot_water_usage, year_month, apartment_id) VALUES (nextval('water_usage_stats_id_seq'), now(), now(), 0, 40.000, 60.000, '2023-10-01', 2);
INSERT INTO public.tariff(id, version, created_on, created_by, updated_on, updated_by, cold_water_price, hot_water_price, trash_price, start_date, end_date) values (nextval('tariff_id_seq'), 0, now(), null, now(), null, 9.81, 9.02, 2.22, '2023-05-01', '2023-11-30');
INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2023-09-16', true, 1);
INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2023-09-16', true, 2);

INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2031-11-16', true, 1);
INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2031-11-16', true, 2);
INSERT INTO public.water_meter_check(id, version, created_on, created_by, updated_on, updated_by, meter_reading, check_date, manager_authored, water_meter_id) values (nextval('water_meter_check_id_seq'), 0, now(), null, now(), null, 120.000, '2031-11-16', true, 3);
INSERT INTO public.tariff(id, version, created_on, created_by, updated_on, updated_by, cold_water_price, hot_water_price, trash_price, start_date, end_date) values (nextval('tariff_id_seq'), 0, now(), null, now(), null, 9.81, 9.02, 2.22, '2031-07-01', '2031-08-30');

INSERT INTO public.tariff(id, version, created_on, created_by, updated_on, updated_by, cold_water_price, hot_water_price, trash_price, start_date, end_date) values (nextval('tariff_id_seq'), 0, now(), null, now(), null, 9.81, 9.02, 2.22, '2031-04-01', '2031-06-30');
INSERT INTO public.bill(id, created_on, updated_on, version, date, balance, apartment_id, owner_id, advance_usage, real_usage) VALUES (nextval('bill_id_seq'), now(), now(), 0, '2023-09-01', 1000.00, 1, 2, 1, 2);
INSERT INTO public.bill(id, created_on, updated_on, version, date, balance, apartment_id, owner_id, advance_usage, real_usage) VALUES (nextval('bill_id_seq'), now(), now(), 0, '2023-09-01', 1000.00, 2, 2, 1, 2);