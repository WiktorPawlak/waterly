...
-- mol
INSERT INTO public.invoice(id, version, created_on, created_by, updated_on, updated_by, invoice_number, water_usage, total_cost, date) values (nextval('invoice_id_seq'), 0, now(), null, now(), null, 'FV 2020/01/23', 29.09, 202.57, '2023-05-1');
INSERT INTO public.invoice(id, version, created_on, created_by, updated_on, updated_by, invoice_number, water_usage, total_cost, date) values (nextval('invoice_id_seq'), 1, now(), null, now(), null, 'FV 2020/02/23', 30.09, 222.57, '2023-06-1');
