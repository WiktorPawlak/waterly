...
GRANT SELECT, INSERT, UPDATE ON TABLE account_details_seq TO ssbd06mok;
GRANT SELECT, INSERT, UPDATE ON TABLE account_seq TO ssbd06mok;
GRANT SELECT, INSERT, UPDATE ON TABLE auth_info_seq TO ssbd06mok;
GRANT SELECT, INSERT, UPDATE ON TABLE role_seq TO ssbd06mok;
...
INSERT INTO public.account_details (id, version, email, first_name, last_name, phone_number, created_on, updated_on) VALUES (nextval('account_details_seq'), 0, 'kontomatino@gmail.com', 'Mateusz', 'Strzelecki', '123456789', now(), now());
INSERT INTO public.account (id, version, active, login, password, account_state, account_details_id, created_on, updated_on) VALUES (nextval('account_seq'), 0, true, 'admin', 'admin12345', 'CONFIRMED', 1, now(), now());
INSERT INTO public.role (permissionlevel, id, version, active, account_id, created_on, updated_on) VALUES ('ADMINISTRATOR', nextval('role_seq'), 0, true, 1, now(), now());
INSERT INTO public.administrator (id) VALUES (1);
INSERT INTO public.auth_info (id, last_ip_address, last_success_auth, last_incorrect_auth, incorrect_auth_count, created_on, updated_on, version, account_id) VALUES (nextval('auth_info_seq'), null, null, null, 0, now(), now(), 0, 1);