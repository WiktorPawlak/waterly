          ...
          <DialogContent sx={{ width: "300px" }}>
            ...
            >
              <StyledTextField
                ...
                label={
                  <Trans
                    i18nKey={"editTariffDialog.coldWaterPrice"}
                    components={{ sup: <sup /> }}
                  />
                }
                variant="standard"
                ...
                helperText={
                  coldWaterPriceErrorMessage && t(coldWaterPriceErrorMessage)
                }
              />
              <StyledTextField
                variant="standard"
                ...
                label={
                  <Trans
                    i18nKey={"editTariffDialog.hotWaterPrice"}
                    components={{ sup: <sup /> }}
                  />
                }
                ...
                helperText={
                  hotWaterPriceErrorMessage && t(hotWaterPriceErrorMessage)
                }
              />
              <StyledTextField
                label={
                  <Trans
                    i18nKey={"editTariffDialog.trashPrice"}
                    components={{ sup: <sup /> }}
                  />
                }
                sx={{ width: "100% !important" }}
