import { Accordion, AccordionDetails, AccordionSummary, Box, Button, Popover, Typography, } from "@mui/material";
                            ...
                            <Box>
                                ...
                                >
                                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                                        <Typography>{t("roles." + currentUserRole)}</Typography>
                                    </AccordionSummary>
                                    {account?.roles
                                        ...
                                        .map((role) => (
                                            <AccordionDetails key={role}>
                                                <Button onClick={() => handleChangeRole(role)}>
                                                    <Typography sx={{ textTransform: "none" }}>{t("roles." + role)}</Typography>
                                                </Button>
                                            </AccordionDetails>
                                        ))}
                                </Accordion>
