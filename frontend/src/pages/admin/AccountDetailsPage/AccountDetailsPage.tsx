...
import { EditEmailByAdminDialog } from "../../../layouts/components/account/EditEmailByAdminDialog";
  ...
  return (
    <MainLayout isOverflowHidden={false}>
      ...
      <EditPasswordByAdmin
        ...
        setIsOpen={setEditPasswordDialogOpen}
        email={account.email}
      />
      <EditEmailByAdminDialog
        isOpen={editEmailDialogOpen}
        setIsOpen={setEditEmailDialogOpen}
        account={account}
        etag={etag}
      />
      <Box
          ...
          <Tooltip
            title={
              account.roles.length === 3
                ? t("manageUsersPage.cannotAddRole")
                : ""
            }
          >
            <span>
              <Button
                disabled={account.roles.length === 3}
          ...
          <Tooltip
            title={
              account.roles.length === 0
                ? t("manageUsersPage.cannotRemoveRole")
                : ""
            }
          >
            <span>
              <Button
                disabled={account.roles.length === 0}
                sx={{ mr: 2, textTransform: "none", mb: 2 }}
                variant="contained"
