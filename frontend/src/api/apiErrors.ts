const apiErrors = new Map<string, string>([
  ...
  [
    "ERROR.ACCOUNT_SEARCH_PREFERENCES_NOT_FOUND",
    "apiError.searchPreferencesNotFound",
  ],
  ...
  [
    "ERROR.ERROR_ACCOUNT_NOT_WAITING_FOR_CONFIRMATION",
    "apiError.accountNotWaitingForConfirmation",
  ],
  ...
  [
    "ERROR.MAIN_WATER_METER_ALREADY_EXISTS",
    "validation.mainWaterMeterAlreadyExists",
  ],
  ["ERROR.TARIFF_NOT_FOUND_FOR_INVOICE", "apiError.tariffNotFoundForInvoice"],
  [
    "ERROR.NOT_ALL_WATER_METER_CHECKS_PERFORMED",
    "apiError.notAllWaterMeterChecksPerformed",
  ],
  ["ERROR.INACTIVE_WATER_METER", "validation.inactiveWaterMeter"],
  [
    "ERROR.ILLEGAL_MAIN_WATER_METER_CHECK",
    "apiError.illegalMainWaterMeterCheck",
  ],
  ...
  [
    "ERROR.PREVIOUS_METER_READING_GREATER_THEN_NEW_ONE",
    "apiError.previousMeterReadingGreaterThenNewOne",
  ],
  [
